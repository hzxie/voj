...
#include <jni.h>
/* Header for class com_trunkshell_voj_judger_core_Runner */

#ifndef _Included_com_trunkshell_voj_judger_core_Runner
#define _Included_com_trunkshell_voj_judger_core_Runner
#ifdef __cplusplus
extern "C" {
#endif
/*
