...
public class UserGroup implements Serializable {
   ...
   * @param userGroupSlug - the unique English abbreviation of the user group
  ...
  /**
   * Gets the unique English abbreviation of the user group.
   *
   * @return the unique English abbreviation of the user group
   */
  ...
  /**
   * Sets the unique English abbreviation of the user group.
   *
   * @param userGroupSlug - the unique English abbreviation of the user group
   */
  ...
  /** The unique English abbreviation of the user group. */
