...
public class ComparatorTest {
    ...
    public static void setUp() throws IOException {
        ...
        stdOutputStream = new FileOutputStream(new File("/tmp/voj-matcher-tests/match-exactly-std.txt"));
        ...
        stdOutputStream = new FileOutputStream(new File("/tmp/voj-matcher-tests/match-with-spaces-std.txt"));
        ...
        // TestCase: Mismatch
        stdOutputStream = new FileOutputStream(new File("/tmp/voj-matcher-tests/mimatch-std.txt"));
        outputStream = new FileOutputStream(new File("/tmp/voj-matcher-tests/mimatch.txt"));
        String mismatchString1 = "Mismatch Test";
        String mismatchString2 = "Mismatch\nTest";
        IOUtils.write(mismatchString1, stdOutputStream);
        IOUtils.write(mismatchString2, outputStream);
        // TestCase: OutOfMemoryException
        File outOfMemoryOutFile = new File("/tmp/voj-matcher-tests/match-out-of-memory.txt");
