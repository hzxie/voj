...
<head>
    <meta charset="UTF-8">
    <title><spring:message code="voj.administration.edit-submissions.title" text="Edit Submission" /> #${submission.submissionId} | ${websiteName}</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="container">
            ...
            <!-- Content -->
            <div id="content">
                <h2 class="page-header"><i class="fa fa-edit"></i> <spring:message code="voj.administration.edit-submissions.edit-submission" text="Edit Submission" /></h2>
            </div> <!-- #content -->
        </div> <!-- #container -->
    </div> <!-- #wrapper -->
    <!-- Java Script -->
