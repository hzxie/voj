                ...
                <ul class="nav inline">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<c:url value="/worldwide?forward=${requestScope['jakarta.servlet.forward.request_uri']}" />"><i class="fa fa-language"></i> <spring:message code="voj.administration.include.header.change-language" text="Change Language" /></a></li>
                            <li class="divider"></li>
