                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach var="contestant" items="${contestants}">
                                <tr>
                                    ...
                                    <td class="time">${contestant.time} <spring:message code="voj.contests.leaderboard.min" text="min" /></td>
                                <c:forEach var="problem" items="${problems}">
                                    ...
                                    <c:otherwise>
                                        <a href="<c:url value="/submission/${submission.submissionId}" />" target="_blank">${submission.usedTime} <spring:message code="voj.contests.leaderboard.min" text="min" /></a>
                                    </c:otherwise>
                                    </c:choose>
                                    </td>
                                </c:forEach>
