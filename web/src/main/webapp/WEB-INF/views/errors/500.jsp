...
<head>
    <meta charset="UTF-8">
    <title><spring:message code="voj.error.500.title" text="Internal Server Error" /> | ${websiteName}</title>
    ...
    <link rel="stylesheet" type="text/css" href="${cdnUrl}/css/misc/error.css?v=${version}" />
    <!-- JavaScript -->
...
<body>
    ...
    <div id="content" class="container">
        <div class="row-fluid">
            <div class="span6">
                <img src="${cdnUrl}/img/error.png?v=${version}" alt="Error" />
            </div> <!-- .span6 -->
