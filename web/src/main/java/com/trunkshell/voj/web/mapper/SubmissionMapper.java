...
public interface SubmissionMapper {
	...
	@Results({
		...
		@Result(property = "language", column = "language_id", javaType=Language.class, one = @One(select="com.trunkshell.voj.web.mapper.LanguageMapper.getLanguageUsingId")),
		...
		@Result(property = "judgeResult", column = "submission_judge_result", javaType=JudgeResult.class, one = @One(select="com.trunkshell.voj.web.mapper.JudgeResultMapper.getJudgeResultUsingSlug")),
