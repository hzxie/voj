...
-- Seed the difficulty of the sample problems (1 = Easy, 2 = Medium, 3 = Hard).
...
--
-- Table structure for table `voj_problem_difficulty`
--
...
--
-- Dumping data for table `voj_problem_difficulty`
--
...
--
-- Indexes for table `voj_problem_difficulty`
--
